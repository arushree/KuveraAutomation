...
public class WebAgentFactory {
	...
	public static IAgent createAgent(Configuration config) throws Exception {
		...
		case DESKTOP_WEB:
			...
			Dimension resolution = new Dimension(Integer.parseInt(System.getProperty("browser_resolution_width")),
					Integer.parseInt(System.getProperty("browser_resolution_height")));
